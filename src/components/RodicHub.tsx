...
// Model (rozhodnuto s Janem): PLNÝ HUB+ — nic není zdarma. Prohlížení je jen ochutnávka.
// Nečlen vidí všechny funkce jako dlaždice s prodejním popisem (co to je / jak pomůže),
...
// VŠE JE V HUB+ — hlavní nástroj první, pak objevování a komunita. Žádný free tier.
const TOOLS = [
  ...
  { Icon: MapPin, c: "#2f5d57", t: "Najít trenéra a klub", d: "Trenéři, akademie i kurty na mapě — ceníky, recenze i kontakt na jednom místě.", href: "/mapa" },
  { Icon: MessageSquare, c: "#3b5666", t: "Napsat trenérovi", d: "Napiš přímo na volné termíny, ceny nebo přístup k dětem — a domluv se na pár kliků.", href: "/mapa" },
  { Icon: MessageSquareHeart, c: "#864a59", t: "Poradna", d: "Výběr trenéra, trénink nebo zdraví dítěte? Zeptáš se a odborník odpoví do 48 hodin. Klid místo nekonečného googlení.", href: "/poradna" },
