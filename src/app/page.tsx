...
const PERSONAS: Persona[] = [
  ...
  { key: "rodic-hobby", Icon: Users, label: "Rodič hobby hráče", promise: "Najdi, rezervuj, zaplať — a měj klid.",
    ...
    plus: ["Rezervace a platby na pár kliků", "Zprávy trenérům", "Přehled dítěte — rozvrh a platby", "Parťák na zahrání (matchmaking)", "Články a FAQ návody"] },
  { key: "rodic-zavodni", Icon: Trophy, label: "Rodič závodního hráče", promise: "Konkurenční výhoda pro tvé dítě.",
    free: ["Hledání špičkových specialistů", "Profily a recenze", "Veřejné žebříčky"],
    plus: ["Rezervace a platby", "Profil hráče — výsledky a vývoj", "Plánovač turnajů", "Sparring podle výkonnosti", "Články a FAQ návody"] },
