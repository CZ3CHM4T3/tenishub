...
const QUICK = [
  { Icon: MapPin, t: "Najít trenéra / kurt", s: "specialisté a areály na mapě", href: "/mapa", c: "#7c6018", b: "#F2EAD6" },
  { Icon: Route, t: "Moje cesta", s: "celá sezóna dítěte přehledně", href: "/moje-cesta", c: "#7C4DD6", b: "#EEEDFE" },
  { Icon: Video, t: "Videorozbor", s: "proč to dítěti nejde — poradíme", href: "/videorozbor", c: "#864a59", b: "#F2E5E9" },
  { Icon: Handshake, t: "Sparring", s: "najít dítěti parťáka na zápas", href: "/sparring", c: "#8a5640", b: "#F2E6DF" },
];
        ...
        <div className="prole-grid">
          {QUICK.map((q, i) => (
            <Link key={i} href={q.href} className="prole-card">
              ...
              <span className="prole-txt"><b>{q.t}</b><span>{q.s}</span></span>
