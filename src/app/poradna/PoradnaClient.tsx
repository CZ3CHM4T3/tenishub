    ...
    <div className="acct-page">
      ...
      <div className="wrap acct-wrap" style={{ maxWidth: 820 }}>
        ...
        <div className="pora-intro">
          ...
          <p className="member-note" style={{ margin: 0 }}>Zeptejte se na cokoli kolem tenisu vašeho dítěte — výběr trenéra, trénink, motivaci, zdraví. Odpovídá odborník, odpovědi vidí všichni; ptát se můžou členové <b>HUBmember</b>.</p>
        </div>
